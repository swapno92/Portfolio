...
const Contact = () => {
    return (
        <div className='h-fit w-full bg-[#152526] md:pb-[70px] pt-12 pd:mb-0 pb-4' id='ContactMe'>
            <div data-aos="zoom-in-up" className='flex-col md:px-32 px-5 mt-[80px] '>
                ...
                <p className='text-center text-[#CD5DF3] md:text-4xl text-3xl font-bold md:-mt-20 -mt-9 border-b-4 pb-3 border-[#CD5DF3] font-serif'>Contact With Me</p>
            </div>

            <div className='md:w-[100%] text-white md:flex md:mt-20 mt-10 md:px-10 px-5 gap-4 md:space-y-0 space-y-3'>
                ...
                <div data-aos="zoom-in-left" className='md:w-[65%] border border-cyan-300 p-4  rounded-lg'>
                    ...
                    <form id='myFrom' action="https://formspree.io/f/mvoeprvz"
                        ...
                        <textarea className='w-full bg-[#343A40] mt-5 rounded-md p-2 text-lg' name="message" id="" cols="30" rows="5" placeholder='Message me for more...' required></textarea>
