    ...
    return (
        <>
            <div className='h-fit bg-fixed w-full flex flex-col justify-center items-center bg-Img p-4 md:pt-0' id='home'>
                <h2 className='font-bold text-3xl text-[#ffffff] mb-5 md:pt-48 pt-10'>Welcome to my portfolio</h2>
                <h3 className='font-serif text-white md:text-[50px] text-xl md:font-bold'>
                    {'<'} I'm {' '}
                ...
                <p className='font-semibold text-center md:mt-6 mt-3 text-white text-2xl '>I live in Chittagong, Bangladesh</p>
