    ...
    return (
        <div className=' mySkils-bg w-full h-fit bg-[#362c3c] text-white py-10' id='mySkills'>
            <div className='flex-col md:px-32 px-5 mt-[80px]'>
                ...
                <p className='text-center text-[#CD5DF3] md:text-4xl text-xl font-bold md:-mt-20 -mt-9 border-b-4 pb-3 border-[#CD5DF3]'>Skill's !</p>
            </div>

            <div className='md:mt-16 mt-10 grid md:grid-cols-5 grid-cols-2 gap-5 px-5 pb-10'>
