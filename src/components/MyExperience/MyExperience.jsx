...
const MyExperience = () => {
    return (
        <div className='services_bg  h-fit w-full bg-[#515152] md:px-10 px-3 pt-5 pb-10' id='myExperience'>
            <div data-aos="zoom-in-up" className='flex-col md:px-32 px-5 mt-[75px]'>
                ...
                <p className='text-center text-[#CD5DF3] md:text-4xl text-3xl font-bold md:-mt-20 -mt-9 border-b-4 pb-3 border-[#CD5DF3] font-serif'>My Experience</p>
            </div>
            <div className=' gap-x-5 gap-y-4 mt-8 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 text-white'>
                <div data-aos="flip-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" className='relative pb-8 bg-[#403b3b] px-5 py-2 space-y-1 shadow-[#000000] shadow-lg rounded-lg'>
                ...
                <div data-aos="flip-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="1000" className='bg-[#403b3b] pb-8 relative px-5 py-2 space-y-1 shadow-[#000000] shadow-lg rounded-lg'>
                ...
                <div data-aos="flip-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" className='bg-[#403b3b] pb-8 px-5 relative py-2 space-y-1 shadow-[#000000] shadow-lg rounded-lg'>
                ...
                <div data-aos="flip-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" className='bg-[#403b3b] pb-8 relative px-5 py-2 space-y-1 shadow-[#000000] shadow-lg rounded-lg'>
